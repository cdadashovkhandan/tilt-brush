...
namespace TiltBrush
{
    public class DiskStencil : StencilWidget
    {
        ...
        // This method checks the available transformation on the axis. In this case, the shape can be scaled uniformly or on the x-axis or y-axis, since it is a planar shape
