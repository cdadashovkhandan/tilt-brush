...
namespace TiltBrush
{
    public class OctahedronStencil : StencilWidget
    {
        ...
        // This method checks the available transformation on the axis. In this case, the shape can be scaled uniformly or non uniformly over all axis
        ...
        // If the shape can be, for example, scaled on any of the axis, this is where the transofrmation happens
