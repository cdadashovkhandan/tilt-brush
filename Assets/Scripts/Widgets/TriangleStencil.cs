...
namespace TiltBrush
{
    public class TriangleStencil : StencilWidget
    {
       ...
       public override Vector3 Extents
        ...
        // This method checks the available transformation on the axis. In this case, the shape can be scaled uniformly or on the y-axis or x-axis, since it is a planar shape
        ...
        // If the shape can be, for example, scaled on the x or y-axis, this is where the transofrmation happens
